...
Revision ID: 6a8301c9a797
Revises: 0adb7d80a05b
Create Date: 2018-12-05 14:39:57.005622
...
revision = '6a8301c9a797'
down_revision = '0adb7d80a05b'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('gender', sa.Enum('MALE', 'FEMALE', 'SECURE', 'UNKNOW', name='genderenum'), nullable=True),
